/* ==========================================================================
   منصة الحراسة العامة — مُخدَّمة ضمن الموقع من نفس الخادم (انظر platform/)
   في الإنتاج: الخادم الموحد يقدّم الموقع على / والمنصة على /harasa/
   ========================================================================== */
export const PLATFORM_PATH = '/harasa/';
export const PLATFORM_LABEL = 'منصة الحراسة العامة';
